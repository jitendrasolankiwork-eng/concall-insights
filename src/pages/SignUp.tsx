    ...
    return (
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-12">
          <div className="card-base w-full max-w-sm p-6 text-center space-y-4">
            <div className="text-3xl">📬</div>
            <h1 className="text-base font-bold text-text-primary">Check your email</h1>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="card-base w-full max-w-sm p-6 space-y-5">
          ...
          <div className="space-y-1">
            <h1 className="text-base font-bold text-text-primary">Create your account</h1>
            <p className="text-xs text-text-muted">Track your portfolio with AI insights</p>
          </div>
