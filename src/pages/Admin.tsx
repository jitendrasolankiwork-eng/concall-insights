            ...
            {rows.length === 0 ? (
              ...
              [...rows].sort((a, b) => {
                ...
                >
                  ...
                  {/* Last processed */}
                  <div>
                    <span className="text-xs text-text-muted">{row.lastProcessedAt ? new Date(row.lastProcessedAt).toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric" }) : "—"}</span>
                  </div>
